...
const QUIZZES = [
  {
    ...
    },
    {
      ...
      q: `$9^{-1} \\bmod 26 = ?$`,
      answer: `3`,
      explain: `扩欧：$1 = 3\\cdot 9 - 26$ ⇒ $9^{-1}\\equiv 3$。`
    },
    {
      id: "q4",
      type: `fill`,
    ...
    },
    {
      ...
      q: `$\\gcd(36, 60) = ?$`,
      answer: `12`,
      explain: `$60 = 1\\cdot 36 + 24$；$36 = 1\\cdot 24 + 12$；$24 = 2\\cdot 12$ ⇒ 12。`
    },
    {
      id: "q14",
      type: `fill`,
  ...
  },
  {
    ...
    questions: [
    {
      ...
      points: 3,
      topic: `beth`,
      q: `用 Beth 证 $\\{(p \\lor q) \\to r, \\neg r\\} \\models \\neg p \\land \\neg q$。`,
      answer: `树全闭`,
      explain: `假设 $p\\lor q$ ⇒ 由前提得 $r$，与 $\\neg r$ 矛盾；故 $\\neg(p\\lor q)$ 即 $\\neg p\\land\\neg q$。`
    },
    {
      id: "q2",
      type: `judge`,
    ...
    },
    {
      ...
      q: `$2$ 模 $17$ 的阶 = ?`,
      answer: `8`,
      explain: `$2^8 = 256 = 15\\cdot 17 + 1\\equiv 1\\pmod{17}$；最小指数。`
    },
    {
      id: "q7",
      type: `fill`,
    ...
    },
    {
      ...
      topic: `numtheory`,
      q: `证素数无穷多。`,
      answer: `假设有限：$p_1,\\ldots,p_k$；取 $N = p_1\\cdots p_k + 1$；$N$ 不被任 $p_i$ 整除 ⇒ 存在新素因子，矛盾。`,
      explain: `Euclid 经典证明。`
    },
    {
      id: "q9",
    ...
    },
    {
      ...
      points: 4,
      topic: `numtheory`,
      q: `证 Bézout 引理：$d = \\gcd(a,b) \\Rightarrow \\exists x,y$ 使 $ax + by = d$。`,
      answer: `用扩展欧几里得算法逐步回代余数；最终 $d$ 表为 $a, b$ 的整线性组合。`,
      explain: `扩欧的理论基础。`
    },
    {
      id: "q11",
...
全闭 ✓。`
    ...
    },
    {
      ...
      topic: `numtheory`,
      q: `下列 gcd 性质哪些正确？`,
      options: [`$\\gcd(a,0) = a$`, `$\\gcd(a,b) = \\gcd(b, a\\bmod b)$`, `$\\gcd(ka,kb) = k\\gcd(a,b)$`, `$\\gcd(\\gcd(a,b),c) = \\gcd(a,\\gcd(b,c))$`],
      answer: [0, 1, 2, 3],
      explain: `全是 gcd 基本性质。`
    },
    {
      ...
      q: `$5^{100} \\bmod 7 = ?$`,
      answer: `2`,
      explain: `费马小定理：$5^6 \\equiv 1 \\pmod 7$；$100 = 16 \\cdot 6 + 4$；$5^{100} \\equiv 5^4 = 625 \\equiv 625 - 89 \\cdot 7 = 2 \\pmod 7$。`
    },
    {
      id: "q17",
      type: `mcq`,
  ...
  },
  {
    ...
    },
    {
      ...
      points: 2,
      topic: `base`,
      q: `$0.625$ 在 base 2 中有限。`,
      answer: true,
      explain: `$0.625 = 5/8 = 2^{-3}\\cdot 5$ ⇒ $(0.101)_2$ 有限。`
    },
    {
      id: "q6",
      type: `judge`,
  ...
  },
  {
    ...
    },
    {
      ...
      q: `$53.82$ 既约分数 = ?`,
      answer: `2691/50`,
      explain: `$5382/100$；$\\gcd=2$ ⇒ $2691/50$。`
    },
    {
      id: "q10",
      type: `fill`,
    ...
    },
    {
      ...
      q: `续上：$d = ?$`,
      answer: `29`,
      explain: `$\\varphi=24$；$5\\cdot 29 = 145 = 6\\cdot 24 + 1\\equiv 1$。`
    },
    {
      id: "q13",
      type: `judge`,
    ...
    },
    {
      ...
      q: `$5^{100} \\bmod 11 = ?$`,
      answer: `1`,
      explain: `费马 $5^{10}\\equiv 1$；$100 = 10\\times 10$ ⇒ $1$。`
    },
    {
      id: "q19",
      type: `fill`,
      points: 3,
      topic: `modular`,
      q: `⚠️ $\\mathbb{Z}_{12}$ 中 $4x \\equiv 8 \\pmod{12}$ 有几个解？`,
      answer: `3`,
      explain: `$\\gcd(4,12)=4 | 8$ ⇒ 有解；解数 = $\\gcd = 4$？实际：约简 $x\\equiv 2\\pmod 3$ ⇒ 在 $\\mathbb Z_{12}$ 中得 $\\{2,5,8,11\\}$ 共 4 个。`
    }
    ]
  },
  {
    id: "sim05",
    title: "Sim CC3 — 05 (混合 / 19 题 / 49 分)",
    duration: 90,
    difficulty: 3,
    category: "CC3 混合",
    questions: [
    ...
    },
    {
      ...
      points: 2,
      topic: `numtheory`,
      q: `若 $n = pq$（$p, q$ 不同素），则 $\\varphi(n) = n - p - q + 1$。`,
      answer: true,
      explain: `$(p-1)(q-1) = pq - p - q + 1$。`
    },
    {
      id: "q8",
      type: `judge`,
    ...
    },
    {
      ...
      points: 5,
      topic: `beth`,
      q: `用 Beth 树证 $\\{(p\\lor q)\\to r, r\\to s\\} \\models p\\to s$。`,
      answer: `树全闭`,
      explain: `假设 $p, \\neg s$。β 拆 $(p\\lor q)\\to r$：$\\neg(p\\lor q) | r$。左支与 $p$ 矛盾。右支再 β 拆 $r\\to s$：$\\neg r$ 与 $r$ 矛盾，$s$ 与 $\\neg s$ 矛盾。`
    },
    {
      id: "q11",
      type: `mcq`,
    ...
    },
    {
      ...
      points: 2,
      topic: `numtheory`,
      q: `若 $\\gcd(a,n)=1$ 且 $b\\equiv 0\\pmod n$，则 $ab\\equiv 0\\pmod n$。`,
      answer: true,
      explain: `$n|b$ ⇒ $n|ab$，与 $a$ 无关。`
    },
    {
      id: "q13",
      type: `fill`,
    ...
    },
    {
      ...
      points: 2,
      topic: `numtheory`,
      q: `若 $\\gcd(a,n) = 1$ 且 $\\gcd(b,n) = 1$，则 $\\gcd(ab,n) = 1$。`,
      answer: true,
      explain: `素因子分解论证。`
    }
    ]
  },
  {
    ...
    },
    {
      ...
      q: `$\\varphi(45) = ?$`,
      answer: `24`,
      explain: `$45 = 3^2 \\cdot 5$；$45\\cdot 2/3\\cdot 4/5 = 24$。`
    },
    {
      id: "q15",
      type: `judge`,
  ...
  },
  {
    ...
    },
    {
      ...
      points: 2,
      topic: `numtheory`,
      q: `CRT：$x \\equiv 2\\pmod 5, x \\equiv 3\\pmod 7$；$x \\bmod 35 = ?$`,
      options: [`10`, `17`, `12`, `23`],
      answer: 1,
      explain: `试 $x=2,7,12,17$；$17 \\equiv 3 \\pmod 7$ ✓。`
    },
    {
      id: "q11",
      type: `fill`,
    ...
    },
    {
      ...
      options: [`12`, `8`, `10`, `15`],
      answer: 1,
      explain: `$30 = 2\\cdot 3\\cdot 5$；$\\varphi = 30(1-1/2)(1-1/3)(1-1/5) = 8$。`
    },
    {
      id: "q17",
      type: `fill`,
  ...
  },
  {
    ...
    },
    {
      ...
      points: 2,
      topic: `numtheory`,
      q: `若 $\\gcd(a,n) > 1$，则 $a$ 在 $\\mathbb{Z}_n$ 中无逆元。`,
      answer: true,
      explain: `逆元存在 $\\Leftrightarrow \\gcd(a,n)=1$。`
    },
    {
      id: "q5",
      type: `fill`,
    ...
    },
    {
      ...
      topic: `numtheory`,
      q: `下列整除命题哪些正确？`,
      options: [`$a|b, b|c \\Rightarrow a|c$`, `$a|c, b|c \\Rightarrow ab|c$`, `$a|b \\Rightarrow a|kab$（任意 $k$）`, `$a|b, a|c \\Rightarrow a|(pb+qc)$`],
      answer: [0, 2, 3],
      explain: `(B) 需 $\\gcd(a,b)=1$。`
    },
    {
      id: "q9",
      type: `judge`,
    ...
    },
    {
      ...
      q: `$\\gcd(100, 35) = ?$`,
      answer: `5`,
      explain: `$100 = 2\\cdot 35 + 30$；$35 = 1\\cdot 30 + 5$；$30 = 6\\cdot 5$。`
    },
    {
      id: "q12",
      type: `fill`,
    ...
    },
    {
      ...
      points: 3,
      topic: `numtheory`,
      q: `证 $a^{p^2} \\equiv a^p \\pmod p$（$p$ 质数，$\\gcd(a,p)=1$）。`,
      answer: `由费马 $a^p \\equiv a$ 两次应用。`,
      explain: `$a^p \\equiv a$（费马）；故 $(a^p)^p \\equiv a^p \\pmod p$。`
    },
    {
      id: "q20",
      type: `mcq`,
  ...
  },
  {
    ...
    },
    {
      ...
      points: 3,
      topic: `numtheory`,
      q: `CRT：$x\\equiv 2\\pmod 7, x\\equiv 3\\pmod{11}$；最小正解 = ?`,
      answer: `58`,
      explain: `$x = 2 + 7k$；$2 + 7k\\equiv 3\\pmod{11}$ ⇒ $7k\\equiv 1$ ⇒ $k\\equiv 8$；$x = 58$。`
    },
    {
      id: "q6",
      type: `mcq-multi`,
    ...
    },
    {
      ...
      points: 2,
      topic: `base`,
      q: `$(2026)_{10}$ 转 base 16 = ?（大写）`,
      answer: `7EA`,
      explain: `$2026 = 7 \\cdot 256 + 14 \\cdot 16 + 10 = (7EA)_{16}$`
    },
    {
      id: "q11",
      type: `fill`,
  ...
  },
  {
    ...
    },
    {
      ...
      q: `续上 $e = 7$；$d = ?$`,
      answer: `31`,
      explain: `$7\\cdot 31 = 217 = 3\\cdot 72 + 1$。`
    },
    {
      id: "q6",
      type: `subjective`,
    ...
    },
    {
      ...
      points: 2,
      topic: `base`,
      q: `$1/6$ 在 base 12 中是有限小数。`,
      answer: true,
      explain: `$6 = 2 \\cdot 3$；$12 = 2^2 \\cdot 3$；分母素因子 $\\{2,3\\} \\subseteq \\{2,3\\}$ ⇒ 有限。`
    },
    {
      id: "q8",
      type: `subjective`,
      points: 4,
      topic: `rsa`,
      q: `RSA 中小指数 $e = 3$ 的风险及防范？`,
      answer: `若多用户用 $e=3$ 加密同明文 $m$，攻击者用 CRT 从 3 个密文恢复 $m^3$，再开立方得 $m$。防范：OAEP padding。`,
      explain: `已知攻击向量。`
    },
    {
      id: "q9",
    ...
    },
    {
      ...
      points: 2,
      topic: `modular`,
      q: `$\\mathbb{Z}_{12}$ 中 $5x \\equiv 7 \\pmod{12}$；$x = ?$`,
      answer: `11`,
      explain: `$5^{-1} = 5$（$5\\times 5=25\\equiv 1$）；$x = 5\\times 7=35\\equiv 11$。`
    },
    {
      id: "q15",
      type: `fill`,
  ...
  },
  {
    ...
    questions: [
    {
      ...
      topic: `numtheory`,
      q: `证 $6 | n(n^2 - 1)$ 关键 = ?`,
      answer: `n(n-1)(n+1) 为连续 3 整数，含 2 和 3 的倍数`,
      explain: `$\\text{lcm}(2,3) = 6$。`
    },
    {
      id: "q2",
      type: `judge`,
    ...
    },
    {
      ...
      topic: `numtheory`,
      q: `费马小定理与欧拉定理的关系？`,
      answer: `费马是欧拉在 $n = p$ 素数时的特例：$\\varphi(p) = p - 1$，故 $a^{p-1}\\equiv 1$。欧拉对一般 $n$ 也成立。`,
      explain: `都用于模幂计算和 RSA。`
    },
    {
      id: "q5",
      type: `judge`,
    ...
    },
    {
      ...
      options: [`1`, `3`, `2`, `4`],
      answer: 2,
      explain: `$3^6\\equiv 1$；$2024 = 337\\cdot 6 + 2$；$3^2 = 9 \\equiv 2$。`
    },
    {
      id: "q11",
      type: `mcq`,
    ...
    },
    {
      ...
      points: 2,
      topic: `base`,
      q: `$\\mathbb{Z}_{10}$ 中 $7^{-1} = ?$`,
      answer: `3`,
      explain: `$7\\times 3=21\\equiv 1\\pmod{10}$。`
    },
    {
      id: "q14",
      type: `fill`,
      points: 2,
      topic: `numtheory`,
      q: `CRT：$m\\equiv 3\\pmod 5, m\\equiv 2\\pmod 7$；$m \\bmod 35 = ?$`,
      answer: `23`,
      explain: `$m = 3 + 5k$；$3+5k\\equiv 2\\pmod 7 \\Rightarrow k\\equiv 4\\pmod 7$；$m = 23$。`
    },
    {
      id: "q15",
      type: `judge`,
    ...
    },
    {
      ...
      points: 2,
      topic: `numtheory`,
      q: `$\\gcd(a,b)\\cdot\\text{lcm}(a,b) = ?$`,
      options: [`$ab$`, `$a+b$`, `$|a-b|$`, `$2ab$`],
      answer: 0,
      explain: `基本恒等式。`
    },
    {
  ...
  },
  {
    ...
    },
    {
      ...
      points: 3,
      topic: `ca2`,
      q: `8 位 CA2 码 $X = 10110010$ 的十进制值 = ?`,
      answer: `-78`,
      explain: `首位 1 ⇒ 负数；取反+1：$01001110 = 78$ ⇒ $X = -78$。`
    },
    {
      id: "q17",
      type: `mcq`,
      points: 3,
      topic: `ca2`,
      q: `8 位 CA2 中 $-50 + (-50)$ 的结果是？`,
      options: [`$-100$（无溢）`, `溢出`, `0`, `无法表示`],
      answer: 1,
      explain: `$-100 \\in [-128,127]$ 似可表，但 $-50+(-50)=-100$；编码相加首位会同号变号 → 检测溢出取决于具体编码，结果若为 $0011\\,1100$ 解读为 $+60$ ⇒ 溢出。`
    },
    {
      id: "q18",
      type: `subjective`,
    ...
    },
    {
      ...
      points: 3,
      topic: `rsa`,
      q: `续上：$d = ?$（$ed\\equiv 1\\pmod{\\varphi}$）`,
      answer: `7`,
      explain: `$3\\cdot 7 = 21\\equiv 1\\pmod{20}$。`
    },
    {
      id: "q20",
      type: `fill`,
  ...
  },
  {
    ...
    questions: [
    {
      ...
      q: `$\\gcd(17, 5) = ?$`,
      answer: `1`,
      explain: `$17 = 3\\cdot 5 + 2$；$5 = 2\\cdot 2 + 1$；$2 = 2\\cdot 1$。`
    },
    {
      id: "q2",
      type: `judge`,
    ...
    },
    {
      ...
      points: 2,
      topic: `numtheory`,
      q: `若 $p|ab$ 且 $p$ 素，则 $p|a$ 或 $p|b$。`,
      answer: true,
      explain: `素数定义性质（Euclid 引理）。`
    },
    {
      id: "q5",
      type: `fill`,
    ...
    },
    {
      ...
      points: 2,
      topic: `ca2`,
      q: `8 位 CA2 中 $64 + 64$ 结果与溢出？`,
      options: [`128，无溢`, `$-128$，溢出`, `0，溢出`, `未定义`],
      answer: 1,
      explain: `正+正 ⇒ 应得正；首位变 1 ⇒ 溢出，按位读 = $-128$。`
    },
    {
      id: "q11",
      type: `fill`,
      points: 2,
      topic: `numtheory`,
      q: `CRT：$x\\equiv 1\\pmod 3, x\\equiv 2\\pmod 5$；最小正解 = ?`,
      answer: `7`,
      explain: `$x = 1 + 3t$；$3t\\equiv 1\\pmod 5$ ⇒ $t = 2$；$x = 7$。`
    },
    {
      id: "q12",
      type: `fill`,
    ...
    },
    {
      ...
      points: 2,
      topic: `beth`,
      q: `$1/24$ 在 base 2 中有有限展开。`,
      answer: false,
      explain: `$24 = 2^3\\times 3$；含质因子 3 ∉ {2}，故无限。`
    },
    {
      id: "q20",
      type: `judge`,
  ...
  },
  {
    ...
    },
    {
      ...
      q: `$\\mathbb Z_{15}$ 是整环。`,
      answer: false,
      explain: `$3\\cdot 5\\equiv 0$ 但 $3, 5\\not\\equiv 0$ ⇒ 有零因子。`
    },
    {
      id: "q4",
      type: `mcq`,
    ...
    },
    {
      ...
      points: 2,
      topic: `modular`,
      q: `费马小定理：$2^{10} \\equiv 1 \\pmod{11}$。`,
      answer: true,
      explain: `$11$ 素，$\\gcd(2,11)=1$。`
    },
    {
      id: "q7",
      type: `mcq`,
    ...
    },
    {
      ...
      points: 3,
      topic: `numtheory`,
      q: `扩欧求 $\\gcd(13, 8)$ 的 Bézout 系数 $13x + 8y = 1$；$x = ?$`,
      answer: `-3`,
      explain: `$1 = 5\\cdot 8 - 3\\cdot 13$ ⇒ $x = -3, y = 5$。`
    },
    {
      id: "q11",
      type: `fill`,
    ...
    },
    {
      ...
      q: `8 位 CA2 中 $-90$ 编码 = ?`,
      answer: `10100110`,
      explain: `$90 = 0101\\,1010$；CA2: 取反 + 1 = $1010\\,0110$。`
    },
    {
      id: "q13",
      type: `fill`,
